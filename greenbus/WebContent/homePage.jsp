				...
				<td>
					<div id="header2">
						<div class="btn-group">
							...
							<button type="button" class="btn btn-success">
								<a href="http://localhost:8080/greenbus/Aboutus.html"style="color:white">About Us</a>
							</button>
...
<body>
	<form action="HomeServlet" method = "post">
		...
		<br> <span id="msg"></span> <input type="submit" value="signup"
...
<body>
	<form method="post" action="HomeServlet">
		...
		<span id="msg"></span> <input type="submit" value="login"
		...
		<div class="w3-content w3-section" id="main">
			<img class="mySlides" src="gbus.jpg" id="im" width="1450px"
				height="700px"> <img class="mySlides" src="image2.jpg" id="im"
				width="1450px" height="700px"> <img class="mySlides"
				src="bus7.jpg" id="im" width="1450px" height="700px">
		</div>
		<script>
			var myIndex = 0;
			carousel();
